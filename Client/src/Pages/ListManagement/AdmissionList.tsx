...
import AdmissionPopup from '../../Components/ListManagement/AdmissionPopup'
import TurnOverReport from '../../Components/ListManagement/TurnOverReport'
...
const AdmissionList = (): JSX.Element => {
  const [list, setLists] = useState<DataType2[]>([])
  useEffect(() => {
    axios
      .get('http://localhost:8000/admissionList/admission')
