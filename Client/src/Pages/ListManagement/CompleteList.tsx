...
import AssignPatientPopup from '../../Components/ListManagement/AssignPatientPopup'
...
const CompleteList = (): JSX.Element => {
  const [list, setLists] = useState<DataType2[]>([])
  useEffect(() => {
    axios
      .get('http://localhost:8000/admissionList/complete')
      ...
      operation: (
        <>
          <TakeBackPopUp
            ...
            nextState={'surgery'}
          />
          <AssignPatientPopup waitingListId={list[i]?.waitingListId} />
        </>
      )
    })
  }
